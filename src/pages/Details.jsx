...
const Details = () => {
 ...
 <ToastContainer />
              <Helmet>
                <title>{product.product_title} Details</title>
                ...
                <div className="flex justify-center text-white  mt-5 mb-5">
                ...
                <div className="bg-gray-100 h-[500px] w-2/3 md:absolute rounded-xl md:top-[25%] md:left-[300px] flex items-center ">
                    ...
                    {product.availability ? <div className="bg-green-200 border-2 border-green-300 rounded-xl w-1/4 text-center text-lg font-semibold">In Stock</div> : <div className="bg-red-200 border-2 border-red-800 rounded-xl w-1/2 text-center ">Not Available</div> }
                    ...
                    <div onClick={() => {const isInWishlist = wishlists.some(item => item.product_id === product.product_id);
                                if (!isInWishlist) handleWishlist(product);
                            }}
                            className={`p-3 border border-gray-300 rounded-full ${wishlists.some(item => item.product_id === product.product_id) ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`} ><FaRegHeart />
                            </div>
